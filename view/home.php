                ...
                <div class="item-slick1 item1-slick1" style="background-image: url(views/content/images/home_slide_men.jpg);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                        ...
                        <div class="wrap-btn-slide1 w-size1 animated visible-false" data-appear="zoomIn">
                            <!-- Button -->
                            <a href="../index.php?action=product" class="flex-c-m size2 bo-rad-23 s-text2 bgwhite hov1 trans-0-4">
                                En savoir plus
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="item-slick2 p-l-15 p-r-15">
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt p-t-20">
                                <a href="../index.php?action=product-detail" class="block2-name dis-block s-text3 p-b-5">
